...
const realtime = new RealtimeCoreAdapter(new RealtimeCore(new GeminiLiveProvider()), { provider: "gemini", inputFormat: { sampleRate: 16_000, channels: 1, sampleFormat: "pcm_s16le", frameDurationMs: 20 } });
